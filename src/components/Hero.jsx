  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-32 left-32 w-24 h-px bg-slate-300/30"></div>
        <div className="absolute bottom-32 left-56 w-px h-20 bg-slate-300/30"></div>
        <div className="absolute bottom-12 left-56 w-40 h-px bg-slate-300/30"></div>
        <div className="absolute bottom-12 right-32 w-px h-16 bg-slate-300/30"></div>
        ...
        <div className="absolute bottom-32 left-56 w-3 h-3 bg-slate-300/40 rounded-full"></div>
        <div className="absolute bottom-12 right-32 w-3 h-3 bg-slate-300/40 rounded-full"></div>
        ...
        <div className="absolute bottom-20 left-10 w-28 h-px bg-slate-200/25"></div>
        <div className="absolute bottom-40 right-10 w-px h-18 bg-slate-200/25"></div>
      </motion.div>
      ...
      >
        ...
        <div className="absolute -top-16 -right-16 w-32 h-32 border-2 border-slate-500/15 rounded-full">
          <div className="absolute inset-4 border border-slate-500/10 rounded-full">
            <div className="absolute inset-2 border border-slate-500/10 rounded-full"></div>
          </div>
          {/* Gear teeth */}
          {[...Array(12)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-4 bg-slate-500/10"
              style={{
                top: '-2px',
                left: '50%',
        ...
        <div className="absolute -bottom-12 -left-12 w-24 h-24 border-2 border-slate-400/15 rounded-full">
          <div className="absolute inset-3 border border-slate-400/10 rounded-full">
            <div className="absolute inset-2 border border-slate-400/10 rounded-full"></div>
          </div>
          {/* Gear teeth */}
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="absolute w-1.5 h-3 bg-slate-400/10"
              style={{
                top: '-1.5px',
                left: '50%',
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 skew-hover">
            We deliver advanced{' '}
            <span className="text-blue-500 skew-hover inline-block">
              engineering, automation, and energy solutions
            </span>
          </h1>

          <p className="text-lg text-gray-300 mb-8 skew-hover">
            tailored for the world's most demanding industries.{' '}
            <span className="text-white font-medium skew-hover">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Link to="/services">
              <button className="bg-blue-600 hover:bg-blue-700 transition-all px-6 py-2 rounded-full font-medium skew-hover">
                Services
              </button>
            </Link>
            <Link to="/projects">
              <button className="border border-gray-400 hover:border-white px-6 py-2 rounded-full font-medium skew-hover">
                Our Work
              </button>
            </Link>
          </div>
